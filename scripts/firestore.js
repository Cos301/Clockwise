...
const user_id = "NsspyoTtGTWish94BRxApbnoyxZr";
const addAllData = async () => {
    try {
        const users = [
            {
                ...
                bio: "live love laugh",
                gen_score: 1,
                pfp_url: "https://firebasestorage.googleapis.com/v0/b/clockwise-12e44.appspot.com/o/1%2Fpfp%2Fpfp.jpg?alt=media&token=1b5b5b5b-5b5b-5b5b-5b5b-5b5b5b5b5b5b",
                posts: [
                    "/posts/1111"
                ],
                ...
                messages: [
                    {
                        ...
                        from: "3",
                        timestamp: "2020-01-01T00:00:00.000Z",
                        content: "Have you ever heard the tragedy of darth plagous the wize?"
                    },
                    {
                        message_id: "130",
                        from: "4",
        ...
        const posts = [
            {
                post_id: "1111",
                user_id: "1",
                comments: ["/comments/11111",
                    "/comments/11112"],
                img_url: "https://firebasestorage.googleapis.com/v0/b/clockwise-12e44.appspot.com/o/1%2Fposts%2F1111%2Fpost.jpg?alt=media&token=1b5b5b5b-5b5b-5b5b-5b5b-5b5b5b5b5b5b",
        ...
        const comments = [
            {
                user_id: "1",
                comment_ref: "/comments/11111",
                text: "What a loser of a post, get better noob",
                time_created: "2020-01-01T00:00:00.000Z",
            },
            {
                user_id: "2",
                comment_ref: "/comments/11112",
                text: "Hey! that's mean!",
                time_created: "2020-01-01T00:00:00.000Z",
            },
            , {
                user_id: "1",
                comment_ref: "/comments/11113",
                text: "I'm going two unfollow you now",
                time_created: "2020-01-01T00:00:00.000Z",
            }, {
                user_id: "3",
                comment_ref: "/comments/11114",
                text: "too*",
                time_created: "2020-01-01T00:00:00.000Z",
            }, {
                user_id: "2",
                comment_ref: "/comments/11115",
                text: "to** You are both imbiciles",
                time_created: "2020-01-01T00:00:00.000Z",
            }, {
                user_id: "1",
                comment_ref: "/comments/11116",
                text: "Great post! Very inspiring!",
                time_created: "2020-01-01T00:00:00.000Z",
            }, {
                user_id: "1",
                comment_ref: "/comments/11117",
                text: "Why do you want to do this to yourself?",
                time_created: "2020-01-01T00:00:00.000Z",
            },
            {
                user_id: "2",
                comment_ref: "/comments/11118",
                text: "Because making food is fun",
                time_created: "2020-01-01T00:00:00.000Z",
            },
            {
                user_id: "1",
                comment_ref: "/comments/11119",
                text: "But so much effort!!",
                time_created: "2020-01-01T00:00:00.000Z",
            },
            {
                user_id: "1",
                comment_ref: "/comments/11120",
        ...
        for (const comment of comments) {
            await db.collection('comments').doc(comment.comment_ref).set(comment);
        }
