...
const generateMockData = async () => {
  try {
    const users = [
      {
        id: 'xj3fV47De1Hhbr19F5hKeSLy2vJo',
        email: null,
        displayName: null,
        photoURL: null,
        phoneNumber: null,
        ...
        created: null,
        userProfile: {
          user_id: 'xj3fV47De1Hhbr19F5hKeSLy2vJo',
          username: 'jonDoe',
          password: 'password1',
          first_name: 'Bob',
          last_name: 'doe',
    ...
    const chats = [
      {
        chat_id: '10',
        users: [
          db.collection('users').doc('xj3fV47De1Hhbr19F5hKeSLy2vJo'),
          db.collection('users').doc('2'),
        ],
        messages: [
          {
            message_id: '154',
            from: 'xj3fV47De1Hhbr19F5hKeSLy2vJo',
            timestamp: created,
    ...
    const comments = [
      {
        comment_id: '11111',
        user: db.collection('users').doc('xj3fV47De1Hhbr19F5hKeSLy2vJo'),
